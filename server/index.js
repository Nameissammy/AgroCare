...
connectDB().catch((err) => {
  console.error('Background MongoDB connection failed:', err && err.message ? err.message : err);
  console.error('If you are using Atlas, ensure MONGODB_URI is set in server/.env or exported in your shell and your IP is whitelisted.');
});
